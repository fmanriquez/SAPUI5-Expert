		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#fmcdocumento-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fmcdocumento-display": {
								"semanticObject": "fmcdocumento",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fmc.documento",
									"url": sap.ui.require.toUrl("fmc/documento")
								}
							}
						}
					}
